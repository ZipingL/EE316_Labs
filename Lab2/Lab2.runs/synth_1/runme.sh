...
HD_PWD='C:/Users/liuzi/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_behavorial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decoder_behavorial.tcl
