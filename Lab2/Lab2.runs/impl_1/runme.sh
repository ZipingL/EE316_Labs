...
HD_PWD='C:/Users/liuzi/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_behavorial.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Decoder_behavorial.tcl -notrace
