...
HD_PWD='C:/Users/liuzi/lab2_part2/lab2_part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_behavorial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_behavorial.tcl
