...
HD_PWD='C:/Users/liuzi/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BinaryCodedDecimal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BinaryCodedDecimal.tcl -notrace
