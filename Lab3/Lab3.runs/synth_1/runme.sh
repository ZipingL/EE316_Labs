...
HD_PWD='C:/Users/liuzi/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BinaryCodedDecimal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BinaryCodedDecimal.tcl
